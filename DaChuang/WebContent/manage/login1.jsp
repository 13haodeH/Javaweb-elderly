...
<body>
    ...
    <h5>登录</h5>
            ...
            <form action="login1" method="post"  name="frm"  id="frm">
                <table class="t1" border="0" cellspacing="40" width="650px">
                   <!--第一行	-->
	<tr>
	<td width="100px"><label for="ID">用户名：</label></td>
        <td><input type="text" placeholder="请输入用户名" id="name" style="height: 25px;" name="name">&nbsp;&nbsp;<span></span>
        </td>
       
	</tr>
	<tr>
		<td><label for="name">密码：</label></td>
		<td><input type="password" placeholder="请输入密码" id="pwd" style="height: 25px;" name="pwd"> <span></span></td>
