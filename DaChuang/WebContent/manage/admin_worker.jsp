     ...
     <div class="boss">
        ...
        <div class="left">
            ...
            <div class="left_massage3">
                工作人员信息管理&nbsp;&nbsp;/&nbsp;&nbsp;信息查询&nbsp;&nbsp;/&nbsp;&nbsp;信息添加&nbsp;&nbsp;/&nbsp;&nbsp;信息修改&nbsp;&nbsp;/&nbsp;&nbsp;信息删除
            </div>
            <div class="left_massage4">
             <form action="/DaChuang/manage/admin_doworkerselect" method="get">
                <div class="left_massage41">搜索</div>
                <div class="left_massage42">
                    <input type="text" style="width: 300px;height: 40px" placeholder="请输入您要查询工作人员的名字..." name="keywords" value="${param.keywords}">
                    <input type="submit" value="查询" style="width: 50px;height: 40px; position: relative;left: 320px;top: -42px;">
                </div>
                </form>
            </div>
            <div class="left_massage5">
                <table border="0" width="900px" class="table1" cellspacing="25px">
                    <tr>
                        <td>姓名</td>
                        <td>性别</td>
                        <td>手机号码</td>
                    ...
                    <tr>
                        ...
                        <td>${u.USER_CHOSE}</td>
                        <td>${u.USER_STATU}</td>
                        <td><a href="admin_toworkerupdate?name=${u.USER_NAME}&cpage=${cpage}">点击修改</a></td>
                        <td><a href="javascript:Delete('你确定要删除用户【${u.USER_NAME} 】吗？','admin_doworkerdel?name=${u.USER_NAME}&cpage=${cpage}')">点击删除</a></td>
                    </tr>
                     </c:forEach>
                     <script>
            ...
            <div class="left_massage51">
                    <a href="admin_workeradd.jsp" class="a4">
                        <span>+</span>新增用户</a>
                </div>
                <div class="left_massage52"> 
                共${tsum}条记录，当前是${cpage}/${tpage}页
                <a href="admin_doworkerselect?cp=1${searchParams}">首页</a>
                <a href="admin_doworkerselect?cp=${cpage-1 < 1 ?1:cpage-1}${searchParams}">上一页</a>
                <a href="admin_doworkerselect?cp=${cpage+1> tpage ?tpage:cpage+1}${searchParams}">下一页</a>
                <a href="admin_doworkerselect?cp=${tpage}${searchParams}">尾页</a>
            </div>
        </div>
    </div>
</body>
