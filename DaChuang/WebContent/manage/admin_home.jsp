     ...
     <div class="boss">
        ...
        <div class="left">
            ...
            <div class="left_massage3">
                主页咨询信息管理&nbsp;&nbsp;/&nbsp;&nbsp;信息查询&nbsp;&nbsp;/&nbsp;&nbsp;信息添加&nbsp;&nbsp;/&nbsp;&nbsp;信息修改&nbsp;&nbsp;/&nbsp;&nbsp;信息删除
            </div>
            <div class="left_massage4">
             <form action="/DaChuang/manage/admin_dohomeselect" method="get">
                <div class="left_massage41">搜索</div>
                <div class="left_massage42">
                    <input type="text" style="width: 300px;height: 40px" placeholder="请输入您要查询的咨询人姓名..." name="keywords" value="${param.keywords}">
            ...
            <div class="left_massage5">
                <table border="0" width="900px" class="table1" cellspacing="25px">
                    ...
                    <tr>
                        ...
                        <td>${u.HOMER_TYPE}</td>
                        <td>${u.HOMER_EMAIL}</td>
                        <td>${u.HOMER_MASSAGE}</td>
                        <td><a href="admin_tohomeupdate?name=${u.HOMER_NAME}&cpage=${cpage}">点击修改</a></td>
                        <td><a href="javascript:Delete('你确定要删除药物【${u.HOMER_NAME} 】吗？','admin_dohomedel?name=${u.HOMER_NAME}&cpage=${cpage}')">点击删除</a></td>
                    </tr>
                     </c:forEach>
                     <script>
                ...
                <a href="admin_dohomeselect?cp=1${searchParams}">首页</a>
                <a href="admin_dohomeselect?cp=${cpage-1 < 1 ?1:cpage-1}${searchParams}">上一页</a>
                <a href="admin_dohomeselect?cp=${cpage+1> tpage ?tpage:cpage+1}${searchParams}">下一页</a>
                <a href="admin_dohomeselect?cp=${tpage}${searchParams}">尾页</a>
            </div>
        </div>
    </div>
</body>
