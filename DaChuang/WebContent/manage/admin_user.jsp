     ...
     <div class="boss">
        ...
        <div class="left">
            ...
            <div class="left_massage3">
                老年人信息管理&nbsp;&nbsp;/&nbsp;&nbsp;信息查询&nbsp;&nbsp;/&nbsp;&nbsp;信息添加&nbsp;&nbsp;/&nbsp;&nbsp;信息修改&nbsp;&nbsp;/&nbsp;&nbsp;信息删除
            </div>
            <div class="left_massage4">
             <form action="/DaChuang/manage/admin_douserselect" method="get">
            ...
            <div class="left_massage5">
                <table border="0" width="900px" class="table1" cellspacing="25px">
                    ...
                    <tr>
                        ...
                        <td>${u.USER_NUM}</td>
                        <td>${u.USER_HEALTH}</td>
                        <td><a href="admin_touserupdate?id=${u.USER_ID}&cpage=${cpage}">点击修改</a></td>
                        <td><a href="javascript:Delete('你确定要删除用户【${u.USER_NAME} 】吗？','admin_douserdel?id=${u.USER_ID}&cpage=${cpage}')">点击删除</a></td>
                    </tr>
                     </c:forEach>
                     <script>
            ...
            <div class="left_massage51">
                    <a href="admin_useradd.jsp" class="a4">
                        <span>+</span>新增用户</a>
                </div>
