     ...
     <div class="boss">
        ...
        <div class="left">
            ...
            <div class="left_massage3">
                药物信息管理&nbsp;&nbsp;/&nbsp;&nbsp;信息查询&nbsp;&nbsp;/&nbsp;&nbsp;信息添加&nbsp;&nbsp;/&nbsp;&nbsp;信息修改&nbsp;&nbsp;/&nbsp;&nbsp;信息删除
            </div>
            <div class="left_massage4">
             <form action="/DaChuang/manage/admin_dodrugselect" method="get">
                <div class="left_massage41">搜索</div>
                <div class="left_massage42">
                    <input type="text" style="width: 300px;height: 40px" placeholder="请输入您要查询的药物名称..." name="keywords" value="${param.keywords}">
            ...
            <div class="left_massage5">
                <table border="0" width="900px" class="table1" cellspacing="30px">
                    <tr>
                        <td width="50px">药物ID</td>
                        <td width="65px">药物名称</td>
                        <td>药物用途</td>
                        <td width="70px">药物价格</td>
                        <td>药物规格</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>${u.DRUG_PRICE}</td>
                        <td>${u.DRUG_NUM}</td>
                        <td width="70px"><a href="admin_todrugupdate?id=${u.DRUG_ID}&cpage=${cpage}">点击修改</a></td>
                        <td width="70px"><a href="javascript:Delete('你确定要删除药物【${u.DRUG_NAME} 】吗？','admin_dodrugdel?id=${u.DRUG_ID}&cpage=${cpage}')">点击删除</a></td>
                    </tr>
                     </c:forEach>
                     <script>
            ...
            <div class="left_massage51">
                    <a href="admin_drugadd.jsp" class="a4">
                        <span>+</span>新增药品</a>
                </div>
                <div class="left_massage52"> 
                共${tsum}条记录，当前是${cpage}/${tpage}页
                <a href="admin_dodrugselect?cp=1${searchParams}">首页</a>
                <a href="admin_dodrugselect?cp=${cpage-1 < 1 ?1:cpage-1}${searchParams}">上一页</a>
                <a href="admin_dodrugselect?cp=${cpage+1> tpage ?tpage:cpage+1}${searchParams}">下一页</a>
                <a href="admin_dodrugselect?cp=${tpage}${searchParams}">尾页</a>
            </div>
        </div>
    </div>
</body>
