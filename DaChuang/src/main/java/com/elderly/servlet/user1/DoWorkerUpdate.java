...
/**
 * Servlet implementation class DoWorkerUpdate
 */
@WebServlet("/manage/admin_doworkerupdate")
public class DoWorkerUpdate extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//设置字符集
				...
				//加入到数据库用户表中
				int count = elderly_workerDao.update(w);
				...
				//成功或失败重新定向
					...
					if(count > 0) {
						...
						out.write("location.href='admin_toworkerupdate?name="+workername+"'");
						out.write("</script>");
					}
