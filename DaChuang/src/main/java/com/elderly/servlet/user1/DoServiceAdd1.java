...
/**
 * Servlet implementation class DoServiceAdd1
 */
@WebServlet("/manage/admin_doserviceadd")
public class DoServiceAdd1 extends HttpServlet {
	...
	//创建用户实体
		...
		if(count > 0) {
			response.sendRedirect("admin_doserviceselect");
		}else {
			PrintWriter out = response.getWriter();
			
			out.write("<script>");
			out.write("alert('用户添加失败');");
			out.write("location.href='admin_serviceadd.jsp';");
			out.write("</script>");
		}
	}
