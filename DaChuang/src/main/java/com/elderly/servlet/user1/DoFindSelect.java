...
/**
 * Servlet implementation class DoFindSelect
 */
@WebServlet("/manage/admin_dofindselect")
public class DoFindSelect extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int arr[] = elderly_findDao.totalPage(count,keyword);
		
		//获取所有用户记录
		ArrayList<find_user> list = elderly_findDao.selectAll(cpage,count,keyword);
